              ...
              <Table responsive>
                ...
                {   
                    dataReal.map((prop, key) => {
                      ...
                      let diferenciaprecio =  prop.preciorealdehoy -  (prop.preciomodificadofranja1 > 0 ? prop.preciomodificadofranja1 :  prop.pvprecomendadofranja1);
                      ...
                      <tr>
                          ...
                          {  viewprice ? 
                            <td className={this.state.simular ? 
                              ...
                              >${  view === 'hoy' ? prop.pvprecomendado : prop.pvprecomendado } { this.state.simular ?  <input type="radio"  name={ 'franja1'+prop.nombre+key } id={ key } value={  view === 'manana' ? prop.preciodiariomanana : prop.pvprecomendado }  onClick={this.handSimulate}  defaultChecked={true}/> : '' }</td>
                            :
                            <td className={this.state.simular ? 
                          ...
                          >${  view === 'manana' ? prop.pvprecomendadomananafranja3 :  prop.pvprecomendadofranja3 } { this.state.simular ?  
                            <input type="radio" name={ 'franja3'+prop.nombre+key} id={ key } value={  view === 'manana' ? prop.preciodiariomanana : prop.pvprecomendadofranja3 }  onClick={this.handSimulate}  defaultChecked={true}/> : '' }</td> }
          ...
          <Col md="12" sm="12" xs="12">
            <Card>
              ...
              <CardBody>
                { this.state.simular && !viewprice ?
                <UserProgressTable
                  headers= {['','PRODUCTO','PRECIO ÚLTIMA COMPRA','PRECIO DE COMPRA DE HOY','PRECIO DE COMPRA DE MAÑANA','DIFERENCIA COMPRA HOY/MAÑANA','PRECIO DE VENTA SELECCIONADO FRANJA1','PRECIO DE VENTA SELECCIONADO FRANJA2','PRECIO DE VENTA SELECCIONADO FRANJA3','MARGEN TEÓRICO PROMEDIO','MARGEN REAL PROMEDIO','DIFERENCIA VOLUMEN']}
                  usersData={dataReal}
                ...
                /> :
                <UserProgressTable
                  headers= {['','PRODUCTO','PRECIO ÚLTIMA COMPRA','PRECIO DE COMPRA DE HOY','PRECIO DE COMPRA DE MAÑANA','DIFERENCIA COMPRA HOY/MAÑANA','PRECIO DE VENTA SELECCIONADO','MARGEN TEÓRICO PROMEDIO','MARGEN REAL PROMEDIO','DIFERENCIA VOLUMEN']}
                  usersData={dataReal}
                  simular={this.state.simular}
                  update={this.state.update}
                  viewprice = {this.props.viewprice}
